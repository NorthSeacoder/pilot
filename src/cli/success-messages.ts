...
export function showTestingSuccessMessage(config: SuccessMessageConfig): void {
  ...
  console.log(chalk.gray(`  • TypeScript: ${projectInfo.isTypeScript ? chalk.green('是') : chalk.gray('否')}`))
  console.log(chalk.gray(`  • 工作区: ${projectInfo.hasWorkspace ? chalk.green('是') : chalk.gray('否')}`))
  ...
  if (projectInfo.techStack === 'react') {
    console.log(chalk.gray('  • React Testing Library: https://testing-library.com/docs/react-testing-library/intro/'))
  } else if (projectInfo.techStack.startsWith('vue')) {
    console.log(chalk.gray('  • Vue Testing Library: https://testing-library.com/docs/vue-testing-library/intro/'))
  }
