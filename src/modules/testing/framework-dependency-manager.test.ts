...
describe('FrameworkDependencyManager', () => {
  ...
  describe('getFrameworkDependencies', () => {
    it('should return React dependencies for react techstack', () => {
      const dependencies = FrameworkDependencyManager.getFrameworkDependencies('react', '^18.2.0', false)
    ...
    it('should return Vue 2 dependencies for vue2 techstack', () => {
      const dependencies = FrameworkDependencyManager.getFrameworkDependencies('vue2', '^2.7.0', false)
    ...
    it('should return Vue 3 dependencies for vue3 techstack', () => {
      const dependencies = FrameworkDependencyManager.getFrameworkDependencies('vue3', '^3.3.0', false)
  ...
  describe('isDependencyCompatible', () => {
    it('should validate React Testing Library compatibility', () => {
      ...
      expect(FrameworkDependencyManager.isDependencyCompatible(
